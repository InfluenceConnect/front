...
const mockInfluencers: Influencer[] = [
  ...
  { id: 4, name: 'Influenciador 4', description: 'Descrição do Influenciador 4', image: '/static/images/cards/image4.jpg' },
  { id: 5, name: 'Influenciador 5', description: 'Descrição do Influenciador 5', image: '/static/images/cards/image5.jpg' },
  { id: 6, name: 'Influenciador 6', description: 'Descrição do Influenciador 6', image: '/static/images/cards/image6.jpg' },
  { id: 7, name: 'Influenciador 7', description: 'Descrição do Influenciador 7', image: '/static/images/cards/image7.jpg' },
  { id: 8, name: 'Influenciador 8', description: 'Descrição do Influenciador 8', image: '/static/images/cards/image8.jpg' },
  { id: 9, name: 'Influenciador 9', description: 'Descrição do Influenciador 9', image: '/static/images/cards/image9.jpg' },
];
